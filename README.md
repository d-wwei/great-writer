<p align="center">
  ...
  <p align="center">
    <a href="#三大核心能力">核心能力</a> · <a href="#5-种写作模式">写作模式</a> · <a href="#安装">安装</a> · <a href="./README.en.md">English</a>
  </p>
</p>
...
一套通用 AI 写作技能，覆盖**技术文章、营销文案、研究报告、小红书笔记、技术文档**五大场景。调研驱动、全链路管道、去 AI 味。
...
分层设计：`SKILL.md` 负责路由和管道编排，`core/` 是所有模式共享的写作基因，`modes/` 是各场景的结构模板和自检清单。每个文件独立可读，按需加载。
